...
def getDetail(page = 1,keyword='%c7%dd%c1%f7%b8%d0'):        #######改改改改改改改改改改
    time.sleep(8)
    print('page:' + str(page))
    #汉字转%A%B
...
for i in range(400,450):     #没跑
    ...
    getDetail( page= i + 1, keyword='%c7%dd%c1%f7%b8%d0')           #######改
obj = {
                         #农药残留 20
}
...
with open("！！rmw-禽流感.csv","a+",newline="") as f:       #改文件名字#######改改改改改改改改改改
