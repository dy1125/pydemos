...
def getContent(mainContent):
   ...
   pss = soup.select("div #rwb_zw")
    ...
    if  pss and date:
        ...
        return pss,date
     #网址 http://rencai.people.com.cn/n1/2019/0705/c244800-31215721.html   
...
def article(art_url):
    ...
    with open("人民网地沟油.txt","a+",encoding="utf-8") as file:     #####改名字：一个网站加一个词
	    file.write(str(pss)+"!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")    


for page_number in range(1,5):   #所有负面词列表页999页   #####改页数：人民网共14490篇，每页20篇
