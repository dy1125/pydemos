...
def getContent(mainContent):
   ...
   soup = BeautifulSoup(mainContent,"html.parser")
    ...
    if  pss and date:
     ...
     #民生领域创新成果频出  该文章网址 http://rencai.people.com.cn/n1/2019/1010/c244800-31391433.html
...
def article(art_url):
    ...
    with open("人民网H1N1.txt","a+",encoding="utf-8") as file:     #####改名字：一个网站加一个词
	    file.write(str(pss)+"!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")    


for page_number in range(1,5):   #所有负面词列表页999页   #####改页数：人民网共3525篇，每页20篇
