...
def getContent(mainContent):
   ...
   pss = soup.select("div #p_content")
    ...
    if  pss and date:
        print("==类型:  div #p_content  #p_publishtime")
        return pss,date
#网址  http://scitech.people.com.cn/n1/2016/0120/c1007-28069729.html
   ...
   pss = soup.select("div #p_content")
    ...
    if  pss and date:
        print("==类型:  div #p_content  #p_publishtime")
        return pss,date
    #网址   http://society.people.com.cn/n/2015/1028/c136657-27750492.html   
   ...
   pss = soup.select("div #p_content")
    ...
    if  pss and date:
        print("==类型:  div #p_content  #p_publishtime")
        return pss,date
    #网址 http://world.people.com.cn/n/2015/1026/c157278-27741261.html
...
def article(art_url):
    ...
    with open("人民网化学物质残留.txt","a+",encoding="utf-8") as file:     #####改名字：一个网站加一个词
	    file.write(str(pss)+"!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")    


for page_number in range(1,5):   #所有负面词列表页999页   #####改页数：人民网共122篇，每页20篇,共7篇
